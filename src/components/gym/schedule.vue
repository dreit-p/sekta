...
.time-selector
	.limit
		.description
			p(style="color: red") Занятия в залах начнутся 13 января.
				br
				| С 6 по 12 января в личном кабинете будут доступны тренировки и задания для самостоятельного выполнения.
