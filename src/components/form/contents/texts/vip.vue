...
.content
	...
	p.heavy-text Важно!
	p После оплаты вы получите письмо с небольшой анкетой, которую необходимо заполнить. Если письма нет, проверьте папку «Спам». Если нет и там, напишите нам:&ensp;
		b
