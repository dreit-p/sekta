	...
	article.main-content
		.article-limit
			.text-typography
				...
				p #[b(style='color: rgb(213, 31, 71)') Красный] — для тех, кто прокачан в питании, много тренируется и готов к челленджам.
				p #[b(style='color: rgb(255, 182, 0)') Оранжевый] — для тех, кто хочет взять максимум, но не уверен в своих силах.
				p #[b(style='color: rgb(188, 207, 17)') Зеленый] — восстановительный уровень. Для тех, кто не в ресурсе, но хочет начать делать хоть кто-то.
				p #[b(style='color: rgb(19, 155, 169)') Синий] — минимум усилий. Без комплексной работы — только тренировки, пока не вернутся силы.
