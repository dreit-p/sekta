			...
			.profile-block.profile-block_data
				form.form
					...
					app-input(
						...
						data-vv-as='birthday'
						type="number"
						:class="{ 'error': errors.has('birthday'), 'success': fields.birthday && fields.birthday.valid}"
						:error='errors.first("birthday")'
						name='birthday')

					fieldset.fieldset.fieldset_big
							legend.legend Семейное положение:
